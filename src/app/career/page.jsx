    ...
    <section>
      ...
      >
        <div className='flex flex-col absolute inset-0 justify-center items-center text-center'>
          ...
          <div>
            <a href="#job-openings">
              <button className='bg-[#0FA958] text-white text-xl rounded-md p-3 border border-white border-1'>
                View openings
              </button>
            </a>
          </div>
      ...
      <div className='flex flex-col py-14 mx-28'>
      ...
      <div id="job-openings" className='flex flex-col pb-14 mx-32'>
      ...
      <div className="py-10 items-center text-center">
        ...
        <form className="max-w-md mx-auto">
          ...
          <button 
            type="submit" 
            className="bg-[#0FA958] mb-10 text-white text-xl py-3 px-6 rounded-md hover:bg-green-600 transition-colors duration-300 w-full"
          >
            Subscribe
          </button>
        </form>
