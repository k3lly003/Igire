  ...
  <Card className="w-[calc(33.333%-0.75rem)]">
    <CardContent className="flex flex-col items-center justify-center p-6">
      <div className="flex items-start gap-3">
        <Image src={imageSrc} alt={title} className="w-8 h-8 mb-2" />
        <p className="text-[18px] text-muted-foreground">{title}</p>
      </div>
      <CardTitle className={`text-[24px] font-bold ${color}`}>
        {percentage}
      </CardTitle>
    </CardContent>
  </Card>
            ...
            <CardContent className="flex flex-col items-start p-6">
              ...
              <div>
                <p className="text-sm text-muted-foreground mb-1 font-bold">
                  Items: <span className="text-orange-500 font-bold">37</span>
                </p>
                <p className="text-sm text-muted-foreground font-bold">
                  Amount:{" "}
                  <span className="text-orange-500 font-bold">200.00 RWF</span>
                </p>
              </div>
            </CardContent>
          </Card>
